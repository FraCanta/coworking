    ...
    <>
      ...
      >
        <main>
          <Hero>
            <h1
              className={`${myFont.className} text-[60px] leading-[75px] md:text-[90px] md:leading-[100px] md:w-[100%] lg:text-[120px] text-white dark:text-third md:text-center lg:w-[70%] mx-auto lg:leading-[130px] 2xl:text-[100px] 2xl:text-[120px] 2xla:text-[120px] 2xla:leading-[130px]`}
            >
              Sì. Siamo un’agenzia di incontri.
            </h1>
            <p
              className={`${myFont2.className} font-normal text-[20px] md:text-[30px] lg:text-[45px] text-white dark:text-third md:text-center lg:w-[65%] mx-auto lg:leading-[59px] 2xl:text-[30px]`}
            >
